...
### Dashboard File  
You can access the complete analyzed workbook here: **[Retail_store_sales_analysis](https://github.com/Ebujex/Retail_store_sales_analysis/blob/main/retail_store_sales_clean.xlsx)**  
